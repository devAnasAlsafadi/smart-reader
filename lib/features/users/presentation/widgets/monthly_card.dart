...
import 'package:smart_reader/features/users/presentation/widgets/reading_history_card.dart';
...
class MonthlyCard extends StatelessWidget {
  ...
  const MonthlyCard({super.key, required this.month,required this.userId});
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...month.readings.map((r) => ReadingHistoryCard(reading: r, userId: userId,)),
                  ...
                  Divider(color: AppColors.grey.withValues(alpha: .3),),
                  const SizedBox(height: 8),
                  ...month.payments.map((p) => PaymentItem(payment: p,userId: userId,)),
                ],
              ),
            )
          ],
