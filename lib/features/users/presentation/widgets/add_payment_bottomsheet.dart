...
void showAddPaymentSheet(BuildContext context, {required String userId}) {
  showModalBottomSheet(
    context: context,
    isScrollControlled: true,
    backgroundColor: Colors.transparent,
    builder: (_) {
      return _AddPaymentSheet(userId: userId);
    },
  );
}
...
class _AddPaymentSheet extends StatefulWidget {
  final String userId;
  const _AddPaymentSheet({required this.userId});
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: isLoading ? null : () async {
                          ...
                          context.read<BillingBloc>().add(
                            LoadBillingEvent(widget.userId),
                          );
